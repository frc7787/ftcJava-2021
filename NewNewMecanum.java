...
public class NewNewMecanum extends OpMode
{
    ...
    private Servo tentacle;
    private Servo twontacle;
    ...
    public void init()
    {
        ...
        tentacle   = hardwareMap.get(Servo.class, "tentacle");
        twontacle = hardwareMap.get(Servo.class, "twontacle");
    ...
    public void loop()
    {
        ...
        int fposition = flippy.getCurrentPosition();
telemetry.addData("Pull", pposition);
        ...
        switch (CurrentState)
        {
            case STATE_ARKANSAS:
                if(fposition<1000){
                    if(Statetime.time()<.5){
                        tentacle.setPosition(.98);
                        twontacle.setPosition(0);
                    }else if(Statetime.time()>.5){
                        flippy.setPower(0);
                    }
                }else if(fposition>1000){
                    flippy.setPower(0);
                }
                ...
                {
                    newState(State.STATE_DETROIT);
                }
                else if(gamepad2.dpad_down&&fposition<100)
                {
                    newState(State.STATE_SAULT);
                }
                else
                {
            ...
            case STATE_NEWMEXICO:
                ...
                {
                    if(Statetime.time()<1){
                    flippy.setTargetPosition(710);
                    flippy.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    flippy.setPower(Statetime.time());
                    }else if(Statetime.time()>1){
                        tentacle.setPosition(.335);
                        twontacle.setPosition(.56);
                    }
